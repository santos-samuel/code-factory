---
name: "commit"
description: "Use when the user wants to commit current changes, create a git commit, or asks to commit with a structured message. Triggers: \"commit\", \"commit changes\", \"create a commit\", \"git commit\", \"save changes\"."
---
